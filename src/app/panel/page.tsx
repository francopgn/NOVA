...
import { DollarSign, Eye, TrendingUp, Heart, ChevronRight } from "lucide-react";
...
export default function ProfessionalDashboardPage() {
  ...
  React.useEffect(() => {
    getCurrentProfessional().then(setProfessional);
              ...
              {!bookings ? (
                ...
                pending.map((b) => (
                  <div key={b.id} className="rounded-2xl border border-border bg-card p-4">
                    <BookingRow booking={b} avatarUrl={b.clientAvatar} name={b.clientName} subtitle={`${b.dateLabel} · ${b.startTime}`} />
                    <div className="mt-2 flex gap-2">
                      <Button size="sm" className="flex-1">Aceptar</Button>
